...
admission:
  ...
  cost: One model-invoked catalog line, offset by the caller that inlined this content shrinking by what moved; a body plus two format references, paid only when a session actually writes glossary entries or decision records.
