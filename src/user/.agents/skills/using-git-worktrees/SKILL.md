...
<!--
Source: oss-snapshots/superpowers/using-git-worktrees/
Upstream: https://github.com/obra/superpowers @ f2cbfbefebbfef77321e4c9abc9e949826bea9d7 (v5.1.0)
Last sync: 2026-05-23
Drift policy: accept-periodic-resync. Byte-identical copy of upstream at initial import; the in-tree copy is now authoritative and may diverge. To inspect drift, diff against oss-snapshots/superpowers/using-git-worktrees/.
-->
