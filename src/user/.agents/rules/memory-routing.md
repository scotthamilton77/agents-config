...
| **General** — your working style, a user preference, or a correction that holds across every project | User's `AGENTS.md` or your runtime's native/personal user-scoped memory system | Follows you between projects; not bound to any one codebase |
