...
Claude binding of `<verification-checklist>` steps 1–5. Mandatory for non-trivial work (skip one-liners, config, typos); run in order, each step feeding the next:
