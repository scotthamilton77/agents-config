...
Placement: Claude tree, because the body is the user's own line and only the user is entitled to say it. Not every tool honours a user-invoked declaration; where it goes unhonoured, the model can invoke this and answer a complaint nobody made.
-->
