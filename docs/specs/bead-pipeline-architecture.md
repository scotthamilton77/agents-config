...
| docs-edits-team | claude-opus-4-7 | high | Read, Edit, Write, Grep, Glob, Bash | (none) | cyan | Apply documented prose/spec edits in the `docs-only` formula's `apply-edits` stage. Emits a [`docs-edits-report-v1`](./docs-edits-report-v1.md) YAML to the caller-provided absolute report path. Bead-agnostic. | planned |
