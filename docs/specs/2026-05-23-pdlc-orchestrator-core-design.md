...
| **reviewer-artifact** | A reviewer-added artifact failed its own validator | route to tooling-escalation (same bounded-retry mechanics as `tooling`); do NOT charge Implementer strike |
