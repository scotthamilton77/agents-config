...
# (backend.get(new_id) for track derivation is a third post-create step; it must
# carry created_id on failure exactly like the edge-add and orphan-marker seams
# do.)
