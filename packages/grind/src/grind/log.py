...
appending the missing newline to a complete-but-unterminated line) lives in
`grind.store`, on the append path -- this module is the defense-in-depth half:
it tolerates a torn tail when reading a log no repair has touched yet
