...
# skeleton (8.9a wired it for real); its behavior is covered by test_cli_poll.py.
_SINGLE_ARG_VERBS = [v for v in MVP_VERBS if v not in {"resolve-escalated", "sweep", "poll"}]
