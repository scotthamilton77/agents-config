...
`--format` (spec §4.6 / envelope contract); this module never touches stdout
and never raises on malformed input, since a rendering bug must never break the
stdout invariant it sits beside.
